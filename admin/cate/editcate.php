        ...
        <div class="col-md-4">
          <form action="editcate_deal.php" method="post">
            ...
            <div class="form-group">
              ...
              <input id="slug" type='radio' name="state" value="1" checked>启用
              <input id="slug" type='radio' name="state" value="2">禁用
              <?php }else{ ?>
               <input id="slug" type='radio' name="state" value="1" >启用
              <input id="slug" type='radio' name="state" value="2" checked>禁用
              <?php } ?>
            </div>
            ...
            <div class="form-group">
              ...
              <input id="slug" type='radio' name="show" value="1" checked>启用
              <input id="slug" type='radio' name="show" value="2">禁用
              <?php }else{ ?>
               <input id="slug" type='radio' name="show" value="1">启用
              <input id="slug" type='radio' name="show" value="2" checked>禁用
              <?php } ?>
            </div>
            <div class="form-group">
